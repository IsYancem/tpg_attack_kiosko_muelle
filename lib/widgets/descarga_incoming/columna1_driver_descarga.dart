...
class Columna1DriverDescarga extends StatelessWidget {
  const Columna1DriverDescarga({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(DescargaIncomingVisibilityConfig.show['col1.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // ─────────────── FOTO DEL CONDUCTOR ───────────────
          if (DescargaIncomingVisibilityConfig.show['col1.fotoConductor'] ??
              true)
            AspectRatio(
          ...
          if (DescargaIncomingVisibilityConfig.show['col1.nombreConductor'] ??
              true)
            _DriverNamePanel(
          ...
          // // ─────────────── CÉDULA ───────────────
          // if (DescargaIncomingVisibilityConfig.show['col1.cedula'] ?? true)
          //   AtkInfoPanel(
          //     title: 'CÉDULA',

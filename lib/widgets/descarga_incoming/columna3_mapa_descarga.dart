...
class Columna3MapaDescarga extends StatelessWidget {
  const Columna3MapaDescarga({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(DescargaIncomingVisibilityConfig.show['col3.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (DescargaIncomingVisibilityConfig.show['col3.mapa'] ?? true)
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                  color: p.panelBg,
          ...
          if (DescargaIncomingVisibilityConfig.show['col3.mensajeInferior'] ??
              true)
            Container(

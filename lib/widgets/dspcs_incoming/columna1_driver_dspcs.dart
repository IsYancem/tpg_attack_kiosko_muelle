...
class Columna1DriverDspCs extends StatelessWidget {
  const Columna1DriverDspCs({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(DspCsIncomingVisibilityConfig.show['col1.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // ─────────────── FOTO DEL CONDUCTOR ───────────────
          if (DspCsIncomingVisibilityConfig.show['col1.fotoConductor'] ?? true)
            AspectRatio(
          ...
          // ─────────────── CÉDULA ───────────────
          if (DspCsIncomingVisibilityConfig.show['col1.cedula'] ?? true)
            AtkInfoPanel(
              title: 'CÉDULA',

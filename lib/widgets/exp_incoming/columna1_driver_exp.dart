...
class Columna1DriverExp extends StatelessWidget {
  const Columna1DriverExp({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(ExpIncomingVisibilityConfig.show['col1.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // ─────────────── FOTO DEL CONDUCTOR ───────────────
          if (ExpIncomingVisibilityConfig.show['col1.fotoConductor'] ?? true)
            AspectRatio(
          ...
          // ─────────────── CÉDULA ───────────────
          if (ExpIncomingVisibilityConfig.show['col1.cedula'] ?? true)
            AtkInfoPanel(
              title: 'CÉDULA',

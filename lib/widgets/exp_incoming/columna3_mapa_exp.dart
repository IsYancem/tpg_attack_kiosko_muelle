...
class Columna3MapaExp extends StatelessWidget {
  const Columna3MapaExp({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(ExpIncomingVisibilityConfig.show['col3.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // 💬 Mensaje inferior
          if (ExpIncomingVisibilityConfig.show['col3.mensajeInferior'] ?? true)

...
class Columna3MapaPsc extends StatelessWidget {
  const Columna3MapaPsc({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(PscIncomingVisibilityConfig.show['col3.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (PscIncomingVisibilityConfig.show['col3.mensajeInferior'] ??
              true)
            Container(

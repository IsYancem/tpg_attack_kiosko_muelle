...
class Columna1DriverExm extends StatelessWidget {
  const Columna1DriverExm({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(ExmIncomingVisibilityConfig.show['col1.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // ─────────────── FOTO DEL CONDUCTOR ───────────────
          if (ExmIncomingVisibilityConfig.show['col1.fotoConductor'] ?? true)
            AspectRatio(
          ...
          // ─────────────── CÉDULA ───────────────
          if (ExmIncomingVisibilityConfig.show['col1.cedula'] ?? true)
            AtkInfoPanel(
              title: 'CÉDULA',

...
class Columna3MapaExm extends StatelessWidget {
  const Columna3MapaExm({super.key});

  @override
  Widget build(BuildContext context) {
    if (!(ExmIncomingVisibilityConfig.show['col3.visible'] ?? true)) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (ExmIncomingVisibilityConfig.show['col3.mapa'] ?? true)
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                  color: p.panelBg,
          ...
          if (ExmIncomingVisibilityConfig.show['col3.mensajeInferior'] ?? true)

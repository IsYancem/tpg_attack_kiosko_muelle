// lib/widgets/res_incoming/columna1_driver_res.dart
// Columna del conductor para pantalla RES
...
class Columna1DriverRes extends StatelessWidget {
  const Columna1DriverRes({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // FOTO DEL CONDUCTOR
          if (ResIncomingVisibilityConfig.show['col1.fotoConductor'] ?? true)
            AspectRatio(
          ...
          // CÉDULA
          if (ResIncomingVisibilityConfig.show['col1.cedula'] ?? true)
            AtkInfoPanel(
              title: 'CÉDULA',

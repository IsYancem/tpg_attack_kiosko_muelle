// lib/config/incoming/dsp_incoming_visibility_config.dart
// Autor: Abraham Yance
// Configuración de visibilidad completa para la pantalla DspIncomingScreen
// Cada elemento visual puede activarse o desactivarse con un booleano.

class DspIncomingVisibilityConfig {
  static final Map<String, bool> show = {
    // ════════════════════════════════════════════════════════════════════════════
    // 🔹 PANTALLA PRINCIPAL
    // ════════════════════════════════════════════════════════════════════════════
    'pantalla.dspIncomingScreen': true,

...
class ExpRespesajeServiceException implements Exception {
  final String message;
  ExpRespesajeServiceException(this.message);
  @override
  String toString() => message;
}

class ExpRespesajeService {
  ...
  String get _baseUrl {
    ...
    if (url.isEmpty) {
      throw ExpRespesajeServiceException('BASE_MIDDLEWARE_URL no configurada');
    }
    return url;
  }
  ...
  Future<Map<String, dynamic>> inicializar(
    ...
    try {
      ...
      if (resp.statusCode != 200 && resp.statusCode != 201) {
        throw ExpRespesajeServiceException('HTTP ${resp.statusCode}');
      }
  ...
  // BUILD RUTA REQUEST
  // ═══════════════════════════════════════════════════════════════
  // En _buildRutaRequest de ExpRespesajeService:

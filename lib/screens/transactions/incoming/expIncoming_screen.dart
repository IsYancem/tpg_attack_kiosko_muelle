...
import 'package:tpg_attack_kiosko_muelle/services/apis/exp/exp_transaction_runner.dart';
...
class ExpIncomingScreen extends StatelessWidget {
  const ExpIncomingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const _ExpIncomingScreenBody();
  }
}

class _ExpIncomingScreenBody extends StatefulWidget {
  const _ExpIncomingScreenBody();

  @override
  State<_ExpIncomingScreenBody> createState() => _ExpIncomingScreenBodyState();
}

class _ExpIncomingScreenBodyState extends State<_ExpIncomingScreenBody>
    with TickerProviderStateMixin {
  ExpTransactionRunner? _runner;
  bool _runnerExecuting = false; // ⬅️ Flag atómico

  @override
  void initState() {
    super.initState();
    _runner = ExpTransactionRunner();
